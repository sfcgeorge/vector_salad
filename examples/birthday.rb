...
600.times do # Confetti
  ...
  circle((r1 * 8).ceil, at: [r3 * width, r2 * height], fill: color)
end
...
difference(fill: 'black') do # Camera body
  union do
    rect(300, 200, at: [width / 2 - 150, height / 2 - 100])
    path(
    ...
    rect(50, 15, at: [width / 2 + 90, height / 2 - 115])
  end
  circle(80, at: [width / 2 + 20, height / 2])
end
rect(70, 8, at: [width / 2 - 150, height / 2 - 60], fill: 'darkred')
